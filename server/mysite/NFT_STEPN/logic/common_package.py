#1日の結果
def Output_result_print(i,flg,lv_max,repair_cost,current_engage_gst,df_lv_cost,level,accum_gst,trans_money,initial_cost,df_repair_cost):
    print(f'--------------------------------------{i+1}日目----------------------------------------')
    print('結果')
    if flg == 0:
...
#レート確認
def Rate_print(SOL,GST,GMT,USD_JPY):
    print(f"""
SOL:{SOL}
GST:{GST}
GMT:{GMT}
